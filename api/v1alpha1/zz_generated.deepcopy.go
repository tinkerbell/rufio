...
func (in *MachineSpec) DeepCopyInto(out *MachineSpec) {
	*out = *in
	...
	in.ProviderOptions.DeepCopyInto(&out.ProviderOptions)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in RPCSecrets) DeepCopyInto(out *RPCSecrets) {
	{
		in := &in
		*out = make(RPCSecrets, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RPCSecrets.
func (in RPCSecrets) DeepCopy() RPCSecrets {
	if in == nil {
		return nil
	}
	out := new(RPCSecrets)
