...
type machineFieldReconciler func(context.Context, *bmcv1alpha1.Machine, *bmclib.Client) error
...
func (r *MachineReconciler) doReconcile(ctx context.Context, bm *bmcv1alpha1.Machine, bmPatch client.Patch, logger logr.Logger) (ctrl.Result, error) {
...
func (r *MachineReconciler) reconcilePower(ctx context.Context, bm *bmcv1alpha1.Machine, bmcClient *bmclib.Client) error {
